...
const enRoutes = ["/", "/getting-started", "/foundations/tokens-and-themes", "/foundations/layout", "/foundations/typography", "/foundations/accessibility", "/foundations/coexistence", "/foundations/surfaces", "/examples", "/playground", "/changelog", "/roadmap", "/contributing", "/404", ...["button", "card", "form", "validation", "combobox", "datatable", "picker", "carousel", "megamenu", "dialog", "badge", "alert", "table", "breadcrumb", "pagination", "progress", "skeleton", "disclosure", "tabs", "dropdown", "drawer", "toast"].map((c) => `/components/${c}`)];
