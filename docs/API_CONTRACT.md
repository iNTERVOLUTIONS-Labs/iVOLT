...
| Opciones (`data-iv-*`) | `loop` (true), `zoom` (true), `swipe` (true), `preload` (1), `counter` (true), `captions` (true), `closeText` («Close»), `prevText` («Previous»), `nextText` («Next»), `zoomText` («Zoom»), `galleryLabel` («Image viewer») |
