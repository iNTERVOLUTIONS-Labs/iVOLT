...
export const t = {
  ...
  footer: "iVOLT v0.5 beta · MIT · de iNTERVOLUTIONS",
  alpha: "Software beta: los contratos de 0.5 están congelados; los detalles aún pueden cambiar antes de 0.5.0.",
...
export const componentLabels = {
  ...
  picker: "Selector",
  carousel: "Carrusel",
  megamenu: "Megamenú", hero: "Hero", popover: "Tooltip y popover", command: "Paleta de comandos", dialog: "Diálogo", badge: "Insignia", alert: "Alerta",
