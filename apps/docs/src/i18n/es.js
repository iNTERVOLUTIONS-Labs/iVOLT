...
export const t = {
  ...
  footer: "iVOLT v1.0.0-rc.0 · MIT · de iNTERVOLUTIONS",
  alpha: "Candidata a versión: el contrato de 1.0 está congelado; antes de 1.0.0 solo entran correcciones.",
  ...
  mmTagline: "Catorce familias de contenido, diecinueve interactivas, una sola gramática.",
